...
class Downsample(nn.Module):
    """
    Downsample block for the Discriminator.
    """

    def __init__(self, input_channels, output_channels, kernel_size=4, dropout=False, strides=2, padding=1, padding_mode='reflect', *args, **kwargs):
        ...
        self.model = nn.Sequential(
            nn.Conv2d(self.input_channels, self.output_channels, self.kernel_size, self.strides, self.padding, padding_mode=padding_mode),
...
class Discriminator(nn.Module):
    """
    Discriminator network for image-to-image translation.
    """

    def __init__(self, input_channels, features, *args, **kwargs):
        super().__init__(*args, **kwargs)
    ...
    def forward(self, x, y):
        # Concatenate input and output images along the channel dimension
...
def test():
    """
    Function to test the Discriminator model.
    """
